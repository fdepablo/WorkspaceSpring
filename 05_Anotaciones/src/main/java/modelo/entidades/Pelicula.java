...
public class Pelicula {
	private int id;
	//algun valor por defecto, ojo, esto pone por defecto todos
	//los beans del contexto (incluidos si damos de alta alguno por xml)
	//Quizas mejor ponerlo directamente (private String titulo = "la guerra de las galaxias";
	@Value("La guerra de las galaxias")
